...
<p><b>전국 어느 임가든 지금 바로 쓸 수 있는 웹 서비스로 만들었습니다.</b>
https://forestry-roi-predictor.onrender.com — 네 가지만 고르면 내 산의 수익률이
구간과 함께 나오고, 왜 그 숫자인지, 무엇을 바꾸면 되는지까지 답합니다.</p>
...
뜻입니다.</p>
<p>본 과제는 임가경제조사·임산물생산비조사·임산물생산조사·임업경영실태조사
<b>4종의 마이크로데이터를 계층으로 결합</b>했습니다. 임가 단위 종합 수익성은 Model A가,
품목 단위 정밀 진단은 Model B가 맡으며, 두 모델 모두 CUDA XGBoost와 Optuna 교차검증으로
최적화했습니다. 그 결과 Model A는 현행 방식 대비 <b>4.05배</b>(R² 0.174), Model B는
<b>5.95배</b>(R² 0.624)를 확보했고, 임가경제조사가 패널 자료라는 점을 확인해 직전 연도
실적을 결합하자 <b>10.2배</b>(R² 0.280)까지 올랐습니다.</p>
<p>여기에 KAMIS 도매가격·산림청 보조금 세부사업·기상청 지상관측을 융복합해, 언제·어디에
팔지, 등급을 어떻게 관리할지, 어떤 보조사업을 쓸지까지 <b>금액으로 환산해</b> 제시합니다.</p>
<p style="margin-top:8pt">▸ 웹 서비스 https://forestry-roi-predictor.onrender.com
(무료 호스팅이라 첫 접속 시 1분 정도 걸릴 수 있습니다)<br/>
▸ 분석 코드 https://github.com/BioCode67/forestry-roi-predictor</p>

<p style="font-weight:700;font-size:11pt;color:#23593A;margin-top:14pt">기획서 요약</p>
<p>① <b>결과물이 웹 서비스입니다.</b> 보고서로 끝나지 않고 전국 임가가 접속해 자기 조건을
넣으면 답이 나옵니다 — 예측·설명·처방·비교의 네 단계</p>
<p>② 임업통계 4종을 임가 단위·품목 단위 <b>2계층 모델</b>로 결합해 개별 임가 수익성을 예측</p>
<p>③ 현행 공표 방식(단순 평균) 대비 설명력 <b>4.05배</b> 향상, 평균절대오차 10.2% 감소</p>
<p>④ 임가경제조사의 <b>패널 구조를 복원</b>해 설명력을 10.2배까지 확대 — 새 조사 항목 없이
연도 간 대조표만으로 얻는 개선</p>
<p>⑤ 1차 학습에서 나온 R² 0.91이 <b>데이터 누수임을 자체 적발</b>해 0.62로 교정
(피처–타깃 상관 0.885 → 0.344), 경위를 그대로 기재</p>
<p>⑥ 잡음이 큰 지표임을 감추지 않고 <b>예측구간을 함께 제시</b> (구간 포함률 78.2%)</p>
<p>⑦ 출하시기 1.82배·품질등급 4.22배(밤)·지역 9.79배(잣, 시군구 17곳) 격차를 실측해
개선 여지를 금액으로 환산</p>
